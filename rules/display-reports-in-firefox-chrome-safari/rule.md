...
::: bad  
![Figure: Bad example - SQL RS does not work in Chrome by default](report-display-bad_1728010364870.jpg)  
:::
...
::: good  
![Figure: Good example - SQL RS fixed to correctly display in Chrome](report-display-good_1728010364871.jpg)
:::
